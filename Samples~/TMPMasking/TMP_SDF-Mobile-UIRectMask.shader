// Fork of TextMeshPro's "TextMeshPro/Mobile/Distance Field" (TMP_SDF-Mobile.shader) that adds
// UIRectMask rounded-corner clipping. Identical to the original except for:
...
Properties {
	...
	_ClipRectRadii		("Clip Rect Radii", vector) = (0, 0, 0, 0)
...
SubShader {
	...
	Pass {
		...
		#include "Packages/com.jonshamir.uirect/Scripts/Runtime/Masking/RoundedClip.cginc"   // _ClipRectRadii + roundedClipCoverage()
